...
--1. Display Total Sales Amount by Region.
	...
	SELECT REGION,SUM(SALES_AMOUNT) AS TOTAL_SAL
	FROM SALES_DATA
	GROUP BY REGION

--2. Display Average Sales Amount by Product 

	SELECT PRODUCT,AVG(SALES_AMOUNT) AS AVG_SAL
	FROM SALES_DATA
	GROUP BY PRODUCT
...
--4. Display Minimum Sales Amount by Region and Year 
	...
	SELECT REGION,YEAR,MIN(SALES_AMOUNT) AS MIN_SALE
	FROM SALES_DATA
	GROUP BY REGION,YEAR

--5. Count of Products Sold by Region 

SELECT REGION,COUNT(PRODUCT) AS SOLD_PRODUCT
FROM SALES_DATA
GROUP BY REGION
...
--10. Display Regions with at Least 3 Distinct Products Sold. 
	...
	SELECT REGION,COUNT(DISTINCT PRODUCT) AS PRODUCT_DIS
	FROM SALES_DATA
	GROUP BY REGION
...
--11. Display Years with Minimum Sales Less Than 1000 
	...
	SELECT YEAR,MIN(SALES_AMOUNT) AS MIN_SAL
	FROM SALES_DATA
	GROUP BY YEAR
...
--13. Find the Region Where 'Mobile' Had the Lowest Total Sales Across All Years. 
	...
	SELECT TOP 1 REGION,SUM(SALES_AMOUNT) AS LOW_SALE
	FROM SALES_DATA
...
--14. Find the Product with the Highest Sales Across All Regions in 2023. 
	...
	SELECT TOP 1 PRODUCT,SUM(SALES_AMOUNT) AS MAX_SALE
	FROM SALES_DATA
	WHERE YEAR=2023
	GROUP BY PRODUCT
...
--1. Display Count of Orders by Year and Region, Sorted by Year and Region
	...
	SELECT YEAR,REGION,COUNT(*) AS TOT_REGION
	FROM SALES_DATA
...
--5. Find the Year with the Lowest Total Sales Across All Regions.
	...
	SELECT TOP 1 YEAR,SUM(SALES_AMOUNT) AS TOT_SAL
	FROM SALES_DATA
	GROUP BY YEAR
	ORDER BY SUM(SALES_AMOUNT)
